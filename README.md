...
- [Live Demo Link](https://wineshuga.github.io/EmpowerHER-Foundation/)
...
```sh
  cd my-folder
  git https://github.com/Wineshuga/EmpowerHER-Foundation.git
```
...
Feel free to check the [issues page](https://github.com/Wineshuga/EmpowerHER-Foundation/issues).
...
I would like to thank Microverse for the opportunity to build this. I also give credit to the author
of the Original design idea, [Cindy Shin in Behance](https://www.behance.net/adagio07).
